...
def hypernyms_in_ilsvrc2012_categories(entity):
    ...
    return get_hypernyms("imagenet_utils/helper/categories.txt", entity)
...
def get_ilsvrc2012_categories():
    ...
    with open("imagenet_utils/helper/categories.txt") as f:
        for line in f:
...
def get_WNID_from_index(index):
    ...
    file_path = "imagenet_utils/helper/categories.txt" # change depending on location of categories.txt!
